...
#define KP_roll 0.10
#define KI_roll 0.00
#define KD_roll 75.00
#define KP_pitch 0.10
#define KI_pitch 0.00
#define KD_pitch 75.00
#define KP_yaw 0.10
#define KI_yaw 0.00
#define KD_yaw 75.00
...
int calculateMotorPowers(int irtifa,int uzaklik,int PrRoll, int PrPitch, int PrYaw, double current_Roll, double current_Yaw, double current_Pitch, unsigned long deltatime) {
  ...
  if(motpower1>50) motpower1=50; if(motpower2>50) motpower2=50;  if(motpower3>50) motpower3=50; if(motpower4>50) motpower4=50;

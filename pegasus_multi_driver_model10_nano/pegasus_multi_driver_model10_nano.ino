    ...
    if( receiver_values[0]<1500) {
        ...
        if(servo_val1==0 && servo_val2==180) {
          ...
          uint32_t now= millis();
            ...
            servo_val4++;
            if(servo_val1<=0 && servo_val2>=180) {
              servo_val1=0; servo_val1=180; servo_val1=0; servo_val1=180; 
            }
      ...
      if(servo_val1==180 && servo_val2==0) {
          ...
          uint32_t now= millis();
			    if(now-lastmillis4>50) {
            lastmillis4=now;
            servo_val1++;
            servo_val2--;
            servo_val3++;
            servo_val4--;
            if(servo_val2<=0 && servo_val1>=180) {
              servo_val1=180; servo_val1=0; servo_val1=180; servo_val1=0; 
            }
            servo1.write(servo_val1);
            servo2.write(servo_val2);
            servo3.write(servo_val3);
